...
const PURPLE_PILLS: FloatingPill[] = [
  {
    label: "Uniformed resource indexing",
    top: "55%",
    left: "4%",
    delay: 0.4,
    duration: 10,
  ...
  {
    label: "Access endless resources",
    top: "68%",
    left: "35%",
    delay: 1.6,
    duration: 9,
  ...
  {
    label: "Institute grade resources",
    top: "72%",
    left: "65%",
    delay: 2.1,
    duration: 8,
...
function Pill({
  ...
  const blueClasses =
    "bg-linear-to-br from-[#3B82F640] text-[#9DC1FB]";
  const purpleClasses =
    "bg-linear-to-r from-[#6225A360] text-[#D8B4FE]";
...
export function About() {
  ...
  return (
    ...
    >
      {/* ── Section Header ── */}
      <div className="relative flex flex-col items-start w-full text-center mb-16 md:mb-8">
        {/* Decorative stars */}
        <DecorativeStar
          size={68.83}
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-4 md:gap-6">
        ...
        <motion.div
          ...
          className="relative rounded-[30px] border border-light-border bg-white/3 backdrop-blur-md overflow-hidden min-h-[480px] md:min-h-[248px] p-8 md:p-6 flex flex-col group transition-all duration-300 hover:border-[#3B82F6]/20"
        >
          {/* Radial glow */}
          <div
          ...
          <div className="relative z-10 flex flex-col flex-1">
            <h3 className="font-primary font-medium text-3xl md:text-[20px] leading-[-6%] text-white-text mb-1.5">
              Education has been reactive for{" "}
              <span className="text-[#3B82F6] text-shadow-xs text-shadow-blue-500">
                DECADES.
              </span>
            </h3>

            <p className="font-primary font-medium text-xl md:text-[16px] text-white-text mb-1.5">
              We&apos;re making it{" "}
              <span className="text-white-text bg-text-highlight">
                predictive.
              </span>
            </p>

            <p className="font-primary text-sm md:text-[14px] leading-relaxed text-white-text/50 min-w-full">
        ...
        <div className="flex flex-col gap-4 md:gap-5">
          ...
          <motion.div
            ...
            className="relative rounded-[30px] border border-light-border bg-white/3 backdrop-blur-md overflow-hidden min-h-[300px] md:min-h-[300px] p-7 md:p-6 flex flex-col group transition-all duration-300 hover:border-[#A855F7]/20"
          >
            {/* Purple radial glow */}
            <div
              className="absolute inset-0 rounded-[30px] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            ...
            <div className="relative z-10 flex flex-col flex-1">
              ...
              <p className="font-primary text-sm md:text-[14px] leading-relaxed text-white-text/50">
          ...
          <motion.div
            ...
            className="relative rounded-[30px] border border-light-border bg-white/3 backdrop-blur-md p-7 md:p-6 flex flex-col group transition-all duration-300 hover:border-[#22C55E]/20"
          >
            {/* Green radial glow */}
            <div
              className="absolute inset-0 rounded-[30px] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            ...
            <div className="relative z-10">
              ...
              <p className="font-primary font-normal text-xl md:text-[16px] text-white-text/80 mb-4">
